...
Voilà le geste fondamental de Regard.
...
Regard ne commence donc pas par demander :
...
Regard demande régulièrement à la table de juger ce qui compte dans la fiction. Cette liberté suppose un cadre partagé.
...
Une même Intention peut être poursuivie de nombreuses manières. Regard ne demande pas d’abord quelle règle correspond à l’action. Il demande ce qui, dans la fiction, va réellement peser sur ce que le personnage tente de faire.

## Les conséquences importantes doivent être visibles

Le mot **enjeu** peut être utilisé dans son sens courant pour parler de ce qui risque d’être gagné, perdu ou transformé, mais il ne constitue pas un concept mécanique distinct de Regard.
...
Le Focus possède une échelle. Regard appelle cette propriété le **Zoom**.
...
Un jeu conçu avec Regard peut choisir une autre philosophie de l’égalité. Ce qui importe est qu’il sache ce que l’égalité signifie dans sa propre fiction.
...
Regard doit distinguer clairement l’arbitrage fictionnel de l’arbitraire.
...
Pour les tables qui souhaitent néanmoins garder une trace des déséquilibres successifs, Regard propose une **Jauge de Destin** optionnelle, commune au groupe.
...
# 6. Faire varier et concevoir Regard
...
Regard peut être décrit comme **cognitif** parce que son opération centrale consiste moins à calculer une valeur de personnage qu’à porter un jugement de pertinence sur une situation fictionnelle.
...
Regard peut être décrit comme **diégétique** lorsque les éléments manipulés par la règle restent attachés à des éléments qui possèdent déjà un sens dans la fiction.
...
Ces termes décrivent des possibilités de design. Ils ne constituent pas des labels obligatoires pour utiliser Regard.

---

# 8. Regard en pratique : deux bornes de l’espace de design
...
**Regard: Scooby-Doo** teste la compression : un trope immédiatement identifiable, une création de personnage en quelques mots-clés, des Prismes très caractérisés et une infrastructure minimale.

Les deux donnent deux bornes utiles de l’espace de design.

## Glorantha Perspectives — le test de profondeur

**Glorantha Perspectives** constitue une implémentation complète de Regard.
...
Glorantha est particulièrement adapté à Regard parce que ses cosmologies ne sont pas de simples opinions décoratives posées au-dessus d’une physique mécanique unique.
...
À l’autre extrême, **Regard: Scooby-Doo** montre jusqu’où le framework peut être comprimé sans perdre son idée centrale.
...
Cette création illustre directement la feuille littéraire de Regard : les mots-clés ne définissent pas ce que le personnage a le droit de faire ; ils donnent au joueur une matière facilement mémorisable qui pourra devenir pertinente.
...
Scooby-Doo démontre que Regard peut fonctionner lorsque :
...
Glorantha teste jusqu’où Regard peut **descendre dans la profondeur d’un monde**.
...
Les propositions qui suivent sont volontairement expérimentales. Leur fonction est d’explorer ce que Regard permet de penser lorsqu’on prend au sérieux l’idée qu’une relation au monde peut transformer la résolution elle-même.
...
Regard organise un mouvement simple :
