...
## Le Focus : qu’est-ce que nous ne savons pas encore ?

Une résolution ne sert pas nécessairement à tester si une action « réussit ».

Une réussite ou un échec peut déjà être établi par la fiction. Dans ce cas, la résolution porte sur ce qui reste ouvert : la forme du résultat, son prix, ses conséquences ou ce qu’il transforme.

> **Une résolution ne demande pas forcément : « Est-ce que ça marche ? » Elle demande : « Qu’est-ce que nous ne savons pas encore ? »**

La table précise alors la question à laquelle la résolution doit répondre. Cette question définit le **Focus**.

> *Le garde parvient-il à donner l’alerte avant que tu l’arrêtes ?*
...
Un roi peut refuser nécessairement une demande sans que toute incertitude disparaisse : le Focus peut alors porter sur ce que les personnages préservent de leur relation avec lui. Un bateau peut être condamné à sombrer tandis que la résolution porte sur ce qui peut encore être sauvé.

### Mettre deux issues en balance

Le Focus rend l’incertitude résoluble en mettant **deux issues possibles en balance**.
...
Dans l’exemple du garde, les deux issues pourraient être :

- *le personnage arrête le garde avant qu’il donne l’alerte* ;
- *le garde donne l’alerte avant d’être arrêté*.
...
D’autres événements restent possibles autour de ces issues. Ils appartiennent à l’interprétation, aux conséquences ou à la suite de la fiction, pas nécessairement à la question que cette résolution doit trancher.

Inversement, une fois le Focus accepté, ses deux issues engagent la table : chacune doit réellement pouvoir arriver. Le cadrage ne sert pas à laisser croire qu’une possibilité est en jeu pour la retirer après le tirage.
